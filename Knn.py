...
html_7 = """
<div style="background-color:#6cdc34;padding:15px;border-radius:15px 15px 15px 15px;border-style:'solid';border-color:black">
...
html_8 = """
<div style="background-color:#6f22c6;padding:15px;border-radius:15px 15px 15px 15px;border-style:'solid';border-color:black">
